 ...
 */
public class C49094 extends BaseTest {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "C49094" , dataProviderClass = TestDataProvider.class)

    public void loginFacebook(String iFrmaeNumber, String socNetwork, String email, String pass, String currency) {
