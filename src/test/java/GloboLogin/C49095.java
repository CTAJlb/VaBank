 ...
 */
public class C49095 extends BaseTest {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "C49095" , dataProviderClass = TestDataProvider.class)

    public void loginTwitter(String iFrmaeNumber, String socNetwork, String email, String pass, String currency) {
