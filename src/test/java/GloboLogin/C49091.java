 ...
 */
public class C49091 extends BaseTest {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "C49091" , dataProviderClass = TestDataProvider.class)

    public void loginMailRu(String iFrmaeNumber, String socNetwork, String email, String pass, String currency) {
