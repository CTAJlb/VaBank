 ...
 */
public class C49093 extends BaseTest {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "C49093" , dataProviderClass = TestDataProvider.class)

        public void loginOdnoklassniki(String iFrmaeNumber, String socNetwork, String email, String pass, String currency) {
