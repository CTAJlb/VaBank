 ...
 */
public class C49090 extends BaseTest {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "C49090" , dataProviderClass = TestDataProvider.class)

    public void loginGoogle(String iFrmaeNumber, String socNetwork, String email, String pass, String currency) {
