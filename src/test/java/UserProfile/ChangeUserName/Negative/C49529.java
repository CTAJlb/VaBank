 ...
 */
public class C49529 extends BaseTest {
    ...
    @Test(dataProvider = "C49529", dataProviderClass = TestDataProvider.class)
    public void inputRusUserName(String currency) {
        ...
        userProfile.inputUserName("ТестЮзер");
