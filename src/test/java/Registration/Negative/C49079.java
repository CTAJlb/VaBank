 ...
 */
public class C49079 extends BaseTest{
    ...
    String email = "тест" + random + "@e.mail";
    String password = "testpass";

    @Test(dataProvider = "C49079" , dataProviderClass = TestDataProvider.class)
    public void checkRegEmailRuText(String currency, String expectedErrorMsg, boolean bonus, boolean rules) {
