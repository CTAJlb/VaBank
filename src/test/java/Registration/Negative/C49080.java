 ...
 */
public class C49080 extends BaseTest{
    ...
    String password = "русскийпароль";

    @Test(dataProvider = "C49080" , dataProviderClass = TestDataProvider.class)
    public void checkRegPassRuText(String currency, String expectedErrorMsg, boolean bonus, boolean rules) {
