 ...
 */
public class C49071 extends BaseTest {
    ...
    @Test(dataProvider = "C49071", dataProviderClass = TestDataProvider.class)
    public void registrationRUBCurWithoutBonus(String currency, boolean bonus, boolean rules) {
